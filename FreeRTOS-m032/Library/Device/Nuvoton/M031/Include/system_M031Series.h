...
/* Macro Definition                                                                                        */
/*---------------------------------------------------------------------------------------------------------*/
#define UARTx           UART0       /*!< Select Debug Port which is used for retarget.c to output debug message to UART */
  
#ifndef DEBUG_PORT
#define DEBUG_PORT      UARTx       /*!< Select Debug Port which is used for retarget.c to output debug message to UART */
#endif
